				...
				<div class="auth-box ">
						...
						<div class="content">
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="email" class="form-control" id="email" name="email" placeholder="Eamil" required="">
								</div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Web-Based Blood Bank Management System</h1>
							<p>Developed By <a href="">Akindipe</a></p>
						</div>
					</div>
