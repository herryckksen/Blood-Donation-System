			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="request.php" class=""><i class="lnr lnr-code"></i> <span>Request Blood</span></a></li>
						<li><a href="requestlist.php" class=""><i class="lnr lnr-code"></i> <span>Request List</span></a></li>
						<li><a href="donor.php" class=""><i class="lnr lnr-chart-bars"></i> <span>Donate Blood</span></a></li>
						<li><a href="recentdonor.php" class=""><i class="lnr lnr-chart-bars"></i> <span>Donation List</span></a></li>
						<li><a href="help.php" class=""><i class="lnr lnr-laptop-phone"></i> <span>Contact/Help</span></a></li>
